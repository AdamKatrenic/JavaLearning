...
public class UDPAudioClient {
    ...
    public static void main(String[] args) {
        ...
        try (DatagramSocket clientSocket = new DatagramSocket()) {
            ...
            placeStreamedAudio(clientSocket);
    ...
    private static void placeStreamedAudio(DatagramSocket clientSocket) throws SocketException, LineUnavailableException {
