...
public class SimpleServerChannel {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocketChannel serverChannel = ServerSocketChannel.open()){
            ...
            System.out.println("Server listening on port " + serverChannel.socket().getLocalPort());
            ...
            while (true) {
                ...
                for (int i = 0; i < clientChannels.size(); i++) {
                    ...
                    if (readBytes > 0) {
                        ...
                        System.out.printf("Connectrion to %s lost%n", channel.socket().getRemoteSocketAddress());
                        channel.close();
