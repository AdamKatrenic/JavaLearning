...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("May5th = " + May5th);
        ...
        System.out.println("sevenPM = " + sevenPM.get(ChronoField.AMPM_OF_DAY));
        System.out.println("sevenThirtyPM = " + sevenThirtyPM.get(ChronoField.AMPM_OF_DAY));
